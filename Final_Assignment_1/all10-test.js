...
function cleanseDetails() {
    ...
    for (i in address) {
    if (address[i] == '550 West 155th Street 2nd Floor Guild Room') {
        address[i] = '550 West 155th Street' }
    if (address[i] == '178 Bennett Avenue 2nd Floor (Lorenz Library)') {
        address[i] = '178 Bennett Avenue' }
    if (address[i] == '178 Bennett Avenue Kitchen') {
        address[i] = '178 Bennett Avenue' }
    if (address[i] == '189th Street & Bennett Avenue Kitchen') {
        address[i] = '189th Street and Bennett Avenue' }
    if (address[i] == '502 West165th Street Basement') {
        address[i] = '502 West 165th Street' }
    if (address[i] == '20 Cardinal Hayes Place Enter thru driveway behind Church.') {
        address[i] = '20 Cardinal Hayes Place' }
        if (address[i] == '20 Cardinal Hayes Place Enter through driveway behind Church.') {
        address[i] = '20 Cardinal Hayes Place' }
    }
